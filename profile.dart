...
import 'package:cookitup/FollowersScreen.dart';
import 'package:cookitup/FollowingScreen.dart';
...
class _UserProfileScreenState extends State<UserProfileScreen> {
  ...
  late int _followers = 0;
  late int _following = 0;
  late int _video = 0;
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: [
                GestureDetector(
                  onTap: () {
                    // Navigate to FollowersScreen when followers text is pressed

                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) =>
                            FollowersScreen(userEmail: _userEmail),
                      ),
                    );
                  },
                  child: Text(
                    ...
                    style: TextStyle(
                      ...
                      color: const Color.fromARGB(
                          255, 0, 0, 0), // Change text color to blue
                    ),
                  ),
                ),
                ...
                GestureDetector(
                  onTap: () {
                    // Navigate to FollowingScreen when following text is pressed
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) =>
                            FollowingScreen(userEmail: _userEmail),
                      ),
                    );
                  },
                  child: Text(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ListTile(
                leading:
                    const Icon(Icons.save, color: Colors.black), // Black icon
                title: const Text(
                  'Saved',
              ...
              ListTile(
                leading:
                    const Icon(Icons.info, color: Colors.black), // Black icon
                title: const Text(
                  'About Us',
                  style: TextStyle(color: Colors.black), // Black text color
                ),
